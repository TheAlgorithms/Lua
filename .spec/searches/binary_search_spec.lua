describe("Binary search", function()
	...
	it("should return the negative insertion index if not found", function()
		...
		assert.equals(-4, binary_search({ 2, 3, 4 }, 5))
		assert.equals(-2, binary_search({ 2, 4, 6 }, 3))
	end)
	it("should return the correct index for unique elements", function()
		for _ = 1, 100 do
			...
			assert.equals(pick_index, binary_search(distinct_ints, distinct_ints[pick_index]))
		end
	end)
end)
